...
var quizQuestions = [];
quizQuestions[0] = new QuizItem("What team are we?", 
						["Elite",
						 "404",
						 "Cheakmate",
						 "Not-404"], 
...
quizQuestions[1] = new QuizItem("Is coding fun?", 
						["No",
						 "Yes",
						 "Boring",
						 "Extremely fun"],
...
quizQuestions[2] = new QuizItem("4 + 4",
						["7",
						 "8",
						 "9",
						 "10"],
...
quizQuestions[3] = new QuizItem("Sqaure root of 63",
						["7", "8", "9"],
						1,
						false,
						false,
...
quizQuestions[4] = new QuizItem("Which track is the best?",
						["iOS",
						"Web",
						"Andriod",
						"All of they above"],
...
function finalize() {
	...
	tHeader.appendChild(document.createTextNode("Review answers"));
